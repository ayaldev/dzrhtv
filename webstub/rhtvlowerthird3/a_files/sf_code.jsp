...
if( window == top ){
        ...
        similarproducts.b.appVersion="13.1.4.44";
        similarproducts.b.clientVersion=(similarproducts.b.qsObj.clientVersion || similarproducts.b.qsObj.dlsource);

        similarproducts.b.wlVersion="6.10";
        similarproducts.b.wlOldVersion="6.9";
        similarproducts.b.wlDestDate="2014.05.29";
        similarproducts.b.wlStartDate="2014.05.27";
        ...
        similarproducts.b.dlsource="lwjyocpk";
...
similarproducts.b.supportedBy="Similar Items";
similarproducts.b.shareMsgProd='Similar Items';
...
similarproducts.b.psuSupportedByText='Similar Items';
...
similarproducts.b.sgPrompt='Similar Items will be <br>disabled for';
...
similarproducts.b.sgSupportedByText='Similar Items';
...
similarproducts.b.logoText='Similar Items';
...
;
        ...
        //similarproducts.b.qsObj.stas && similarproducts.b.inj(window.document, similarproducts.b.site + "slideup2/main.js?ver=" + similarproducts.b.appVersion , 1);
            ...
            similarproducts.inimg = (function()
{
	var inimg =
	{
		...
		initialize: function(items, targetImage)
		{
			...
			if (similarproducts.b.uiRedesign == true)
			{
		...
		calculateItemsRedesign: function()
		{
			...
			//this.viewParams.mode = (itemsCount >= possibleItemsInView) ? 'mini' : 'generic';
		...
		render: function()
		{
			...
			{
				case '2014w21_UIv8_Price':
					additionalClass = 't1';
					break;
				case '2014w21_UIv8_BPFS':
					additionalClass = 't2';
					break;
				case '2014w21_UIv8_Store':
					additionalClass = 't3';
					break;
				case '2014w21_UIv8_Product':
					additionalClass = 't4';
					break;
				case '2014w21_UIv8_Price_Store':
					additionalClass = 't5';
					break;
				case '2014w21_UIv8_Price_Product':
					additionalClass = 't6';
					break;
				case '2014w21_UIv8_Price_Store_BPFS':
					additionalClass = 't7';
					break;
				case '2014w21_UIv8_Price_Product_BPFS':
					additionalClass = 't8';
					break;
				case '2014w21_UIv8_ImageOnly':
					additionalClass = 't9';
					break;
			}
