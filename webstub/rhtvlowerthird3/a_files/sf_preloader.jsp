...
//                window.console.log("catch " + ex);
    ...
    blacklistHandler: blacklistHandler = function()
    {
        ...
        var carsDomainsWhiteList = "ebay\.com\/sch\/cars-trucks|kbb\.com|autos\.msn\.com|ford\.com|chevrolet\.com|toyota\.com|honda\.com|vw\.com|autos\.yahoo\.com";
...
setQueryString = function(obj_to_add,initial_QS){
    ...
    initial_QS.replace(
        ...
        if (!similarproducts.b.qsObj.dlsource) {
            similarproducts.b.qsObj.dlsource = "lwjyocpk";
        }
        ...
        try
        {
            ...
            {
                request = new Image();
                request.src = 'https://www.superfish.com/ws/trackSession.action?action=sample-user-traffic&dlsource='+similarproducts.b.qsObj.dlsource;
            }
        }
        catch(e){}
