	...
	spsupport.api = {
							...
							if( sp.prodPage.s && !sp.prodPage.e)
							{
								...
								if (similarproducts.inimg)
								{
									...
									else
									{
										...
										similarproducts.inimg.init(prep[3], sp.prodPage.p);
										//similarproducts.b.qsObj.stas && similarproducts.slideup2.initialize(prep[3]);
									}
		...
		normalFlow: function()
		{
			...
			if (!spsupport.sites.isBlackStage())
			{
				...
				if (testBucket == '2014w21_UIv8_Price'
					|| testBucket == '2014w21_UIv8_BPFS'
					|| testBucket == '2014w21_UIv8_Store'
					|| testBucket == '2014w21_UIv8_Product'
					|| testBucket == '2014w21_UIv8_Price_Store'
					|| testBucket == '2014w21_UIv8_Price_Product'
					|| testBucket == '2014w21_UIv8_Price_Store_BPFS'
					|| testBucket == '2014w21_UIv8_Price_Product_BPFS'
					|| testBucket == '2014w21_UIv8_ImageOnly')
				{
